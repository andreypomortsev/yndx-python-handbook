...
Во время теста в папке `tests` будут созданы временные файлы `wrapped_*.py` которые удаляться после прохождения тестов.
...
| Задание                  | Решение              | Тесты                |
|--------------------------|----------------------|----------------------|
| А. Привет, Яндекс!       | [✅](./2.1/a.py) | [✅](./tests/2.1/a.py) |
| B. Привет, всем!         | [✅](./2.1/b.py) | [✅](./tests/2.1/b.py) |
| C. Излишняя автоматизация | [✅](./2.1/c.py) | [✅](./tests/2.1/c.py) |
