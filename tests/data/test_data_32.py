a_test_data = [
    ("змееед\n", {"з", "д", "м", "е"}, "first open test"),
    ("велосипед\n", set("исолвдеп"), "second open test"),
    (
        "ффффффффффффф\n",
        {
            "ф",
    ...
    ("1122334455 66 77 88 999\n", set("123456789 "), "multiple digits"),
    ("..//,,!!\n", set("./,!"), "punctuation"),
    (
        "12132 !! .s,dddf dwefllsjcb _ +=123\n",
        set("j+dfl3sc_w be,!21.="),
        "all at once",
    ),
]

b_test_data = [
    ("змееед\nвелосипед\n", set("ед"), "first open test"),
    ("мама\nпапа\n", {"а"}, "second open test"),
    ("21 \n34 ", {" "}, "whitespace"),
    ("12345\n12345\n", set("12345"), "equal digits positive"),
    ("12345\n6789\n", set(), "different digits negative"),
    ("!@#$%^&*()\n!@#$%^&*()\n", set("!@#$%^&*()"), "equal special chars"),
    (
        "!@#$2%4^s&*()\n!h@k#8$6%^&*()\n",
        set("!@#$%^&*()"),
        "noisy special chars",
...
p_test_data = [
    ...
    (
        ...
        "\n",
        {"березка", "обрыв", "река", "мангуст", "Морти"},
        "all in one place",
    ),
]
